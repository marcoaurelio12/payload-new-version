...
| Descrição | `Adjudication.tsx:54` | `"Ao confirmar a proposta, o seu gestor..."` | — | ⚠️ Hardcoded (pode manter) |
| Texto do botão | `Adjudication.tsx:73` | `"CONFIRMAR PROPOSTA"` | — | ⚠️ Hardcoded (pode manter) |
...
| Texto do botão | `CTAFinal.tsx:50` | `"CONFIRMAR PROPOSTA"` | — | ⚠️ Hardcoded (pode manter) |
...
| "CONFIRMAR PROPOSTA" | `Calculator.tsx:269` | Hardcoded | ⚠️ Hardcoded (pode manter) |
| "Valores s/ IVA • Pagamento 50% na Confirmação" | `Calculator.tsx:272` | Hardcoded | ⚠️ Hardcoded (pode manter) |
